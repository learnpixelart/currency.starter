...
Benchmark.bm(15) do |x|
  ...
  x.report( 'reader(json):' )   { n.times do CsvJson.read( "#{data_dir}/finance/o/MSFT.json.csv" ); end }
  x.report( 'reader(yaml):' )   { n.times do CsvYaml.read( "#{data_dir}/finance/MSFT.csv" ); end }
...
Benchmark.bm(15) do |x|
  ...
  x.report( 'reader(json):' )    { n.times do CsvJson.read( "#{data_dir}/weather/o/Hobo_15minute_2017.json.csv" ); end }
  x.report( 'reader(yaml):' )    { n.times do CsvYaml.read( "#{data_dir}/weather/Hobo_15minute_2017.csv" ); end }
end
